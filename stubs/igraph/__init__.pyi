...
class Graph(GraphBase):
    ...
    def predecessors(self, vertex, loops: bool = True, multiple: bool = True): ...
    def successors(self, vertex, loops: bool = True, multiple: bool = True): ...
    @property
    def vs(self): ...
    @property
    def es(self): ...
    ...
    community_fluid_communities: Incomplete
    community_spinglass: Incomplete
    community_voronoi: Incomplete
    ...
    def get_all_simple_paths(self, v, to=None, minlen: int = 0, maxlen: int = -1, mode: str = 'out', max_results=None): ...
    def path_length_hist(self, directed: bool = True): ...
    def dfs(self, vid, mode=...): ...
    def spanning_tree(self, weights=None, return_tree: bool = True, method: str = 'auto'): ...
